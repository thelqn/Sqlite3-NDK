...
void throw_sqlite3_exception(JNIEnv *env, sqlite3 *handle, int errcode) {
    ...
    jclass exClass = env->FindClass("com/thelqn/sqlite3/SQLiteException");
...
JNIEXPORT jlong Java_com_thelqn_sqlite3_SQLitePreparedStatement_prepare(JNIEnv *env, jobject object,
                                                                        jlong sqliteHandle,
                                                                        jstring sql) {
    ...
    if (SQLITE_OK != errcode) {
        __android_log_print(ANDROID_LOG_ERROR, APPNAMEFORLOG, "The value is %d", errcode);
...
JNIEXPORT void Java_com_thelqn_sqlite3_SQLitePreparedStatement_reset(JNIEnv *env, jobject object,
                                                                     jlong statementHandle) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
...
JNIEXPORT void Java_com_thelqn_sqlite3_SQLitePreparedStatement_finalize(JNIEnv *env, jobject object,
                                                                        jlong statementHandle) {
    sqlite3_finalize((sqlite3_stmt *) (intptr_t) statementHandle);
}

JNIEXPORT void
Java_com_thelqn_sqlite3_SQLitePreparedStatement_bindByteBuffer(JNIEnv *env, jobject object,
                                                               jlong statementHandle, jint index,
                                                               jobject value, jint length) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
...
JNIEXPORT void
Java_com_thelqn_sqlite3_SQLitePreparedStatement_bindString(JNIEnv *env, jobject object,
                                                           jlong statementHandle, jint index,
                                                           jstring value) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
...
JNIEXPORT void Java_com_thelqn_sqlite3_SQLitePreparedStatement_bindInt(JNIEnv *env, jobject object,
                                                                       jlong statementHandle,
...
JNIEXPORT void Java_com_thelqn_sqlite3_SQLitePreparedStatement_bindLong(JNIEnv *env, jobject object,
                                                                        jlong statementHandle,
...
JNIEXPORT void
Java_com_thelqn_sqlite3_SQLitePreparedStatement_bindDouble(JNIEnv *env, jobject object,
                                                           jlong statementHandle, jint index,
                                                           double value) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
...
JNIEXPORT void Java_com_thelqn_sqlite3_SQLitePreparedStatement_bindNull(JNIEnv *env, jobject object,
                                                                        jlong statementHandle,
                                                                        jint index) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
...
JNIEXPORT void
Java_com_thelqn_sqlite3_SQLiteDatabase_closedb(JNIEnv *env, jobject object, jlong sqliteHandle) {
    sqlite3 *handle = (sqlite3 *) (intptr_t) sqliteHandle;
...
JNIEXPORT void Java_com_thelqn_sqlite3_SQLiteDatabase_beginTransaction(JNIEnv *env, jobject object,
                                                                       jlong sqliteHandle) {
    sqlite3 *handle = (sqlite3 *) (intptr_t) sqliteHandle;
    sqlite3_exec(handle, "BEGIN", 0, 0, 0);
}

JNIEXPORT void Java_com_thelqn_sqlite3_SQLiteDatabase_commitTransaction(JNIEnv *env, jobject object,
                                                                        jlong sqliteHandle) {
    sqlite3 *handle = (sqlite3 *) (intptr_t) sqliteHandle;
...
JNIEXPORT jint Java_com_thelqn_sqlite3_SQLiteCursor_columnCount(JNIEnv *env, jobject object,
                                                                jlong statementHandle) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
...
JNIEXPORT jint
Java_com_thelqn_sqlite3_SQLiteCursor_columnType(JNIEnv *env, jobject object, jlong statementHandle,
                                                jint columnIndex) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
    return sqlite3_column_type(handle, columnIndex);
}

JNIEXPORT jint Java_com_thelqn_sqlite3_SQLiteCursor_columnIsNull(JNIEnv *env, jobject object,
                                                                 jlong statementHandle,
                                                                 jint columnIndex) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
...
JNIEXPORT jint Java_com_thelqn_sqlite3_SQLiteCursor_columnIntValue(JNIEnv *env, jobject object,
                                                                   jlong statementHandle,
                                                                   jint columnIndex) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
    int valType = sqlite3_column_type(handle, columnIndex);
...
JNIEXPORT jlong Java_com_thelqn_sqlite3_SQLiteCursor_columnLongValue(JNIEnv *env, jobject object,
                                                                     jlong statementHandle,
                                                                     jint columnIndex) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
    int valType = sqlite3_column_type(handle, columnIndex);
...
JNIEXPORT jdouble
Java_com_thelqn_sqlite3_SQLiteCursor_columnDoubleValue(JNIEnv *env, jobject object,
                                                       jlong statementHandle, jint columnIndex) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
    int valType = sqlite3_column_type(handle, columnIndex);
    if (SQLITE_NULL == valType) {
        return 0;
...
JNIEXPORT jstring
Java_com_thelqn_sqlite3_SQLiteCursor_columnStringValue(JNIEnv *env, jobject object,
                                                       jlong statementHandle, jint columnIndex) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
...
Java_com_thelqn_sqlite3_SQLiteCursor_columnByteArrayValue(JNIEnv *env, jobject object,
                                                          jlong statementHandle, jint columnIndex) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
...
JNIEXPORT jlong
Java_com_thelqn_sqlite3_SQLiteCursor_columnByteBufferValue(JNIEnv *env, jobject object,
                                                           jlong statementHandle,
                                                           jint columnIndex) {
    sqlite3_stmt *handle = (sqlite3_stmt *) (intptr_t) statementHandle;
